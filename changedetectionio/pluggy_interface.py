...
def register_builtin_fetchers():
    ...
    """
    from changedetectionio.content_fetchers import requests, playwright, puppeteer, webdriver_selenium, xquik
    ...
    if hasattr(xquik, 'xquik_plugin'):
        plugin_manager.register(xquik.xquik_plugin, 'builtin_xquik')
