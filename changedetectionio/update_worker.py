    ...
    def send_content_changed_notification(self, t, watch_uuid):
        ...
        if 'notification_urls' in n_object and n_object['notification_urls']:
            ...
            n_object.update({
                ...
                'diff_added': diff.render_diff(watch_history[dates[-2]], watch_history[dates[-1]], False, False, True, line_feed_sep=line_feed_sep),
                'diff_removed': diff.render_diff(watch_history[dates[-2]], watch_history[dates[-1]], False, True, False, line_feed_sep=line_feed_sep),
